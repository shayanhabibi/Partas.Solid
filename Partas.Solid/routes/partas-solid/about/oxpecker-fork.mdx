...
hero:
    text: Oxpecker
    tagline: Full Stack F# Framework
    actions:
        - theme: alt
          text: Support Oxpecker!
          link: https://github.com/lanayx/Oxpecker
    image:
        src: https://github.com/Lanayx/Oxpecker/raw/develop/images/oxpecker.png
---


:::warning[Excuse the ramble.]
...
```fsharp title="Some of my early days Fable/Feliz code"
let Default () =
    // ...
    Html.div [
...
:::warning[]
    There are plenty of occasions where the compiled code has to be explored
    as a sanity check.
:::
...
And there was no level of using functions, static parameters, or
optional method parameters that would replace the following issue: it was impossible, just like in feliz, for me to write
a component, and then use the Oxpecker DSL with those components. 
...
component package? Not supported.
