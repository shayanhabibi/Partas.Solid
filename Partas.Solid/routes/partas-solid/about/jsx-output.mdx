...
```fsharp tab title="F#" collapse={8-10,14-17,22-24} wrap
[<Erase>]
type Button() =
...
```js tab title="Feliz" collapse={2-45}
function AppSideBar() {
...
```jsx tab title="Partas.Solid" collapse={2-34}
...
:::tip[Clarification]
    The above example is not an admonishment of Feliz, its authors/contributors, nor users; it is simply
    a demonstration of what Fable 5.0 and Partas have to offer.
:::
