...
module HtmlAttributes =
    ...
    type HTMLAttributes with
        ...
        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div class='", Suffix = "' >")>]
        // [<Erase>]
        member _.class'
            with set (_: string) = ()
        ...
        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div accessKey='", Suffix = "' >")>]
        member _.accessKey
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div contenteditable='", Suffix = "' >")>]
        member _.contenteditable
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div contextmenu='", Suffix = "' >")>]
        member _.contextmenu
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div dir='", Suffix = "' >")>]
        member _.dir
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div draggable='", Suffix = "' >")>]
        member _.draggable
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div hidden='", Suffix = "' >")>]
        member _.hidden
            with set (_: U2<string, bool>) = ()
            and [<Erase>] get (): U2<string, bool> = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div id='", Suffix = "' >")>]
        member _.id
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div is='", Suffix = "' >")>]
        member _.is
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div inert='", Suffix = "' >")>]
        member _.inert
            with set (_: bool) = ()
            and [<Erase>] get (): bool = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div lang='", Suffix = "' >")>]
        member _.lang
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div spellcheck='", Suffix = "' >")>]
        member _.spellcheck
            with set (_: bool) = ()
            and [<Erase>] get (): bool = unbox ()
        ...
        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div style='", Suffix = "' />")>]
        member this.style
            with inline set (value: string) = this.style'' <- value
            and inline [<Erase>] get (): string = !!this.style''

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div tabindex='", Suffix = "' >")>]
        member _.tabindex
            with set (_: int) = ()
            and [<Erase>] get (): int = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div title='", Suffix = "' >")>]
        member _.title
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div translate='", Suffix = "' >")>]
        member _.translate
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div about='", Suffix = "' >")>]
        member _.about
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div datatype='", Suffix = "' >")>]
        member _.datatype
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div inlist='", Suffix = "' >")>]
        member _.inlist
            with set (_: obj) = ()
            and [<Erase>] get () = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div popover='", Suffix = "' >")>]
        member _.popover
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div prefix='", Suffix = "' >")>]
        member _.prefix
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div property='", Suffix = "' >")>]
        member _.property
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div resource='", Suffix = "' >")>]
        member _.resource
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div typeof='", Suffix = "' >")>]
        member _.typeof
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div vocab='", Suffix = "' >")>]
        member _.vocab
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div autocapitalize='", Suffix = "' >")>]
        member _.autocapitalize
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div slot='", Suffix = "' >")>]
        member _.slot
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div color='", Suffix = "' >")>]
        member _.color
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div itemprop='", Suffix = "' >")>]
        member _.itemprop
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div itemscope='", Suffix = "' >")>]
        member _.itemscope
            with set (_: bool) = ()
            and [<Erase>] get (): bool = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div itemtype='", Suffix = "' >")>]
        member _.itemtype
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div itemid='", Suffix = "' >")>]
        member _.itemid
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div itemref='", Suffix = "' >")>]
        member _.itemref
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div part='", Suffix = "' >")>]
        member _.part
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div exportparts='", Suffix = "' >")>]
        member _.exportparts
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<div inputmode='", Suffix = "' >")>]
        member _.inputmode
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()
    ...
    type AnchorHTMLAttributes with
        ...
        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<a href='", Suffix = "' >")>]
        member _.href
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<a hreflang='", Suffix = "' >")>]
        member _.hreflang
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<a media='", Suffix = "' >")>]
        member _.media
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()
        ...
        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<a referrerpolicy='", Suffix = "' >")>]
        member _.referrerpolicy
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<a rel='", Suffix = "' >")>]
        member _.rel
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<a target='", Suffix = "' >")>]
        member _.target
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()

        [<Erase>]
        [<LanguageInjection("jsx", Prefix = "<a type='", Suffix = "' >")>]
        member _.type'
            with set (_: string) = ()
            and [<Erase>] get (): string = unbox ()
