...
export declare function StringBuilder__Append_Z721C83C5(x: StringBuilder, s: Nullable<string>): StringBuilder;
export declare function StringBuilder__Append_487EF8FB(x: StringBuilder, s: Nullable<string>, startIndex: int32, count: int32): StringBuilder;
export declare function StringBuilder__Append_244C7CD6(x: StringBuilder, c: string): StringBuilder;
export declare function StringBuilder__Append_61B1CA(x: StringBuilder, c: string, repeatCount: int32): StringBuilder;
