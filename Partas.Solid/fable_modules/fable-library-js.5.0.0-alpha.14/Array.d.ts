...
import { IComparer, Nullable, IEqualityComparer } from "./Util.js";
...
export declare function empty<$a>(cons: Nullable<any>): $a[];
...
export declare function equalsWith<T>(equals: ((arg0: T, arg1: T) => boolean), source1: T[], source2: T[]): boolean;
