...
export declare function getBytesBoolean(value: boolean): Uint8Array<ArrayBuffer>;
export declare function getBytesChar(value: char): Uint8Array<ArrayBuffer>;
export declare function getBytesInt16(value: int16): Uint8Array<ArrayBuffer>;
export declare function getBytesInt32(value: int32): Uint8Array<ArrayBuffer>;
export declare function getBytesInt64(value: int64): Uint8Array<ArrayBuffer>;
export declare function getBytesUInt16(value: uint16): Uint8Array<ArrayBuffer>;
export declare function getBytesUInt32(value: uint32): Uint8Array<ArrayBuffer>;
export declare function getBytesUInt64(value: uint64): Uint8Array<ArrayBuffer>;
export declare function getBytesSingle(value: float32): Uint8Array<ArrayBuffer>;
export declare function getBytesDouble(value: float64): Uint8Array<ArrayBuffer>;
